    ...
    ReentrancyGuardUpgradeable // Adding this unused mixin to help with linearization
{
     ...
     * This may apply when selling NFTs that were not minted on ABCpro.
     */
    ...
    {
        try IABCNFT721(nftContract).tokenCreator(tokenId) returns (
        ...
        returns (address payable, address payable)
    {
        ...
        try
            IABCNFT721(nftContract).getTokenCreatorPaymentAddress(tokenId)
