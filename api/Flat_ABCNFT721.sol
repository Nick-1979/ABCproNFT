...
// File @openzeppelin/contracts-upgradeable/utils/introspection/ERC165StorageUpgradeable.sol@v4.1.0
...
// File @openzeppelin/contracts-upgradeable/utils/math/SafeMathUpgradeable.sol@v4.1.0
...
// File @openzeppelin/contracts-upgradeable/utils/structs/EnumerableMapUpgradeable.sol@v4.1.0
...
// File solidities/ABCNFT721/mixins/OZ/ERC721Upgradeable.sol
    ...
    IERC721EnumerableUpgradeable
{
    ...
    function balanceOf(address owner) public view override returns (uint256) {
        require(owner != address(0), "balance_for_0_address");
    ...
    function ownerOf(uint256 tokenId) public view override returns (address) {
        return _tokenOwners.get(tokenId, "owner_q_for_nonexistent_token");
    }
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "ERC721Metadata: URI_query_nonexistent_token"
        );
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(to != owner, "approval_current_owner");

        require(
            _msgSender() == owner || isApprovedForAll(owner, _msgSender()),
            "approver_not_owner_nor_approvedAll"
        );
    ...
    function getApproved(uint256 tokenId)
        ...
        returns (address)
    {
        require(_exists(tokenId), "approved_query_nonexistent_token");
     ...
     */
    function setApprovalFirstBiderForAllonABC(address payable _minter,address operator, bool approved)
        internal
        virtual
    {
 
        //require(operator != _msgSender(), "approve_to_caller");

 
        _operatorApprovals[_minter][operator] = approved;
 
        emit ApprovalForAll(_minter, operator, approved);
    }
    ...
    function transferFrom(
        ...
        uint256 tokenId
              ...
              console.log("starting transferFrom ... ownerOf(tokenId)");
              console.logAddress( ownerOf(tokenId));


        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "transferer_notOwner_nor_approved"
        );

        _transfer(from, to, tokenId);
                      console.log("end transferFrom.");
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "transfer_to_nonERC721Receiver_implementer"
        );
    }
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId)
        ...
        returns (bool)
    {
        require(_exists(tokenId), "operator_query_nonexistent_token");
        address owner = ownerOf(tokenId);
    ...
    //  *
    //  * - `tokenId` must not exist.
    //  * - `creator` and `minter` cannot be the zero address.
    //  *
    //  * Emits a {Transfer} event.
    //  */
    // function _mintOnABC(address creator, address minter, uint256 tokenId) internal virtual {
    //   require(creator != address(0) && minter != address(0), "mint_to_0");
    //   require(!_exists(tokenId), "already_minted");

    //   _beforeTokenTransfer(address(0), creator, tokenId);

    //   _holderTokens[creator].add(tokenId);
    ...
    function _transfer(
        ...
        require(ownerOf(tokenId) == from, "transfer_token_not_own");
        require(to != address(0), "transfer_to_0_address");
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI)
        ...
        virtual
    {
        require(_exists(tokenId), "ERC721Metadata: URI_set_nonexistent_token");
...
// File solidities/ABCNFT721/mixins/ABCproTreasuryNode.sol
...
abstract contract ABCproTreasuryNode is Initializable {
  ...
  function _initializeABCproTreasuryNode(address payable _treasury) internal initializer {
    require(_treasury.isContract(), "ABCproTreasuryNode: Address_not_contract");
    treasury = _treasury;
  }
...
// File solidities/ABCNFT721/interfaces/IAdminRole.sol
...
// File solidities/ABCNFT721/mixins/roles/ABCproAdminRole.sol
...
// File solidities/ABCNFT721/mixins/HasSecondarySaleFees.sol
...
// File solidities/ABCNFT721/mixins/NFT721Core.sol
...
// File solidities/ABCNFT721/interfaces/IABCNFTMarket.sol
...
// File solidities/ABCNFT721/mixins/NFT721Creator.sol
...
abstract contract NFT721Creator is Initializable, ERC721Upgradeable {
    ...
    modifier onlyCreatorAndOwner(uint256 tokenId) {
        require(
            ...
            "NFT721Creator: Caller_not_creator"
        );
        require(
            ownerOf(tokenId) == msg.sender,
            "NFT721Creator: Caller_not_own_NFT"
        );
        _;
    }
    ...
    function _setTokenCreatorPaymentAddress(
        ...
        if (tokenCreatorPaymentAddress != address(0)) {
            tokenIdToCreatorPaymentAddress[
                tokenId
...
// File solidities/ABCNFT721/mixins/NFT721Market.sol
...
// File solidities/ABCNFT721/mixins/NFT721Metadata.sol
...
// File solidities/ABCNFT721/mixins/NFT721Mint.sol
...
// File solidities/ABCNFT721/ABCNFT721.sol
