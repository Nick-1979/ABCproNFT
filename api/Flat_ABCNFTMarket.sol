...
// File solidities/ABCNFTMarket/mixins/ABCproTreasuryNode.sol
...
abstract contract ABCproTreasuryNode is Initializable {
     ...
     */
    function _initializeABCproTreasuryNode(address payable _treasury)
        internal
        initializer
    {
        require(
            _treasury.isContract(),
            "ABCproTreasuryNode: Address is not a contract"
        );
        treasury = _treasury;
    }
...
// File solidities/ABCNFTMarket/interfaces/IAdminRole.sol
...
// File solidities/ABCNFTMarket/mixins/roles/ABCproAdminRole.sol
...
// File solidities/ABCNFTMarket/mixins/NFTMarketCore.sol
...
// File solidities/ABCNFTMarket/mixins/SendValueWithFallbackWithdraw.sol
...
// File solidities/ABCNFTMarket/interfaces/IABCNFT721.sol
...
// File solidities/ABCNFTMarket/mixins/NFTMarketCreators.sol
...
// File solidities/ABCNFTMarket/mixins/Constants.sol
...
// File solidities/ABCNFTMarket/mixins/NFTMarketFees.sol
    ...
    SendValueWithFallbackWithdraw
{
    ...
    {
        return (
            _primaryABCproFeeBasisPoints,
            _secondaryABCproFeeBasisPoints,
        ...
        )
    {
        ...
        address payable ownerRevTo;
        (ABCproFee, creatorFeeTo, creatorFee, ownerRevTo, ownerRev) = _getFees(
            nftContract,
            tokenId,
            seller,
            price
    ...
    function _updateMarketFees(
        ...
        require(
            primaryABCproFeeBasisPoints < BASIS_POINTS,
            "NFTMarketFees: Fees >= 100%"
        );
        require(
            secondaryABCproFeeBasisPoints.add(secondaryCreatorFeeBasisPoints) <
                BASIS_POINTS,
            "NFTMarketFees: Fees >= 100%"
        );
...
// File solidities/ABCNFTMarket/mixins/NFTMarketAuction.sol
...
// File solidities/ABCNFTMarket/mixins/NFTMarketReserveAuction.sol
    ...
    NFTMarketAuction
{
    ...
    /**
     * @notice Mint for the first bider and approve market for him
     *
     */
    ...
    function MintForAndplaceFirstBidOnABC(
        ...
        // mint for first bider
        console.log("minting for:");
        console.logAddress(_tokenCreatorAddress);
        try
...
// File solidities/ABCNFTMarket/ABCNFTMarket.sol
    ...
    NFTMarketReserveAuction
{
    ...
    function adminUpdateConfig(
        ...
        _updateMarketFees(
            primaryABCFeeBasisPoints,
            secondaryABCFeeBasisPoints,
            secondaryCreatorFeeBasisPoints
        );
    }
